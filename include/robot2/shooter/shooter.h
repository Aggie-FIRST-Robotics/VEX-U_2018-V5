...
namespace AFR::VexU::Robot::Shooter{
    ...
    const int HOOD_TOLERANCE = 90;
    const int HOOD_VOLTAGE = 6000;
    const double HOOD_ENCODER_SCALING = 1.0;
    const int HOOD_ENCODER_LIMIT = 500;

    const int TURRET_TOLERANCE = 90;
    ...
    const double MIN_I_TERM 				= -6000;
    const double MAX_I_TERM 				= 6000;
    const unsigned int FLWHEEL_TOLERANCE 	= 100;


    const double LOADER_FIRE_THRESHOLD = 360;
